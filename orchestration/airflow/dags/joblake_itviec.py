"""ITviec only. CLI reloads the mounted YAML at each task start."""
import pendulum
...
with DAG(
    dag_id="joblake_itviec",
    description="ITviec discovery -> raw HTML -> local PostgreSQL",
    ...
    for phase in ("discovery", "detail", "parse"):
        tasks.append(BashOperator(
            ...
            bash_command=(
                ...
                "-m joblake.main --config configs/itviec.yaml "
