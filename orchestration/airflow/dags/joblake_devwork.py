"""Devwork. CLI reloads the mounted YAML at each task start."""
...
with DAG(
    dag_id="joblake_devwork",
    description="Devwork discovery -> raw HTML -> local PostgreSQL",
    ...
    for phase in ("discovery", "detail", "parse"):
        tasks.append(BashOperator(
            ...
            bash_command=(
                ...
                "-m joblake.main --config configs/devwork.yaml "
