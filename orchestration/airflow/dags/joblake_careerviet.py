"""CareerViet. CLI reloads the mounted YAML at each task start."""
...
with DAG(
    dag_id="joblake_careerviet",
    description="CareerViet discovery -> raw HTML -> local PostgreSQL",
    ...
    for phase in ("discovery", "detail", "parse"):
        tasks.append(BashOperator(
            ...
            bash_command=(
                ...
                "-m joblake.main --config configs/careerviet.yaml "
