"""JobsGO. CLI reloads the mounted YAML at each task start."""
...
with DAG(
    dag_id="joblake_jobsgo",
    description="JobsGO discovery -> raw HTML -> local PostgreSQL",
    ...
    for phase in ("discovery", "detail", "parse"):
        tasks.append(BashOperator(
            ...
            bash_command=(
                ...
                "-m joblake.main --config configs/jobsgo.yaml "
