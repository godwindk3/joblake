"""Vieclam24h. CLI reloads the mounted YAML at each task start."""
...
with DAG(
    dag_id="joblake_vieclam24h",
    description="Vieclam24h discovery -> raw HTML -> local PostgreSQL",
    ...
    for phase in ("discovery", "detail", "parse"):
        tasks.append(BashOperator(
            ...
            bash_command=(
                ...
                "-m joblake.main --config configs/vieclam24h.yaml "
