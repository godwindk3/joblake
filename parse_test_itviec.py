...
# # Benefits
# benefits_heading = soup.find(
#     "h2",
#     string=lambda text: text and text.strip() == "Why you'll love working here"
# )

# benefits_container = benefits_heading.find_parent(
#     "div",
#     class_="imy-5 paragraph"
# )

# benefits = (
#     benefits_container.get_text("\n", strip=True)
#     if benefits_container
#     else None
# )

# # Recruiter name
# employer = soup.select_one("div.employer-name")

# employer = employer.get_text(" ", strip=True) if employer else None
